...
function StatusBadge({ status }: { status: BookingStatus }) {
  ...
  return (
    <span className={m[status] ?? "badge-neutral"}>
      {status.replace("_", " ")}
    </span>
  );
}
...
export default function AdminBookings() {
  ...
  const { data, loading, refresh } = useRequest(
    () =>
      bookingsApi
        .adminGetAll({ page, limit: 10, search, status: statusFilter })
        .then((r) => r.data.data),
  ...
  const columns = [
    ...
    },
    {
      key: "restaurantName",
      title: "Restaurant",
      render: (b: Booking) => b.restaurantName || "—",
    },
    {
      key: "datetime",
      title: "Date & Time",
    ...
    },
    {
      key: "partySize",
      title: "Party",
      render: (b: Booking) => `${b.partySize} guests`,
    },
    {
      key: "status",
      title: "Status",
        ...
        {viewTarget && (
          <div className="space-y-3">
            ...
            {(() => {
              ...
              return (
                <div
                  className={`flex items-center justify-between px-4 py-3 rounded-xl border ${c.bg} ${c.border}`}>
                  <div className="flex items-center gap-2">
                    <span
                      className={`w-2 h-2 rounded-full flex-shrink-0 ${c.dot}`}
                    />
                    <span
                      className={`text-sm font-semibold capitalize ${c.text}`}>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-slate-800 mt-0.5">
                      {viewTarget.createdAt
                        ? dayjs(viewTarget.createdAt).format(
                            "MMM D, YYYY · HH:mm",
                          )
                        : "—"}
                    </p>
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-primary-700">
                      {(
                        viewTarget.contactCustomerName ||
                ...
                <div className="space-y-2 pl-1">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm text-slate-700">
                      {viewTarget.contactCustomerPhone ||
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm text-slate-700 break-all">
                      {viewTarget.contactCustomerEmail ||
            ...
            {viewTarget.specialRequests && (
              <div className="rounded-xl border border-amber-200 bg-amber-50 overflow-hidden">
                ...
                <p className="px-4 py-3 text-sm text-amber-900 leading-relaxed">
                  {viewTarget.specialRequests}
                </p>
              </div>
            )}
            ...
            {viewTarget.cancellationReason && (
              <div className="rounded-xl border border-red-200 bg-red-50 overflow-hidden">
                ...
                <p className="px-4 py-3 text-sm text-red-900 leading-relaxed">
                  {viewTarget.cancellationReason}
                </p>
              </div>
            )}
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl bg-red-50 border border-red-200">
              ...
              <div>
                ...
                <p className="text-sm text-red-600 mt-0.5">
                  ...
                  {dayjs(cancelTarget.date).format("MMM D")} at{" "}
                  {cancelTarget.time} · {cancelTarget.partySize} guests
                </p>
              </div>
            </div>
