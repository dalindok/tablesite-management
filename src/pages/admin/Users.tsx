...
export default function UsersPage() {
  ...
  const { data, loading, refresh } = useRequest(
    () =>
      usersApi
        .getAll({ page, limit: 10, search, role: roleFilter })
        .then((r) => r.data.data),
  ...
  const columns = [
    {
      ...
      render: (u: User) => (
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center flex-shrink-0 w-8 h-8 text-sm font-semibold rounded-full bg-primary-100 text-primary-600">
    ...
    },
    {
      key: "phone",
      title: "Phone",
      render: (u: User) => u.phone || <span className="text-slate-300">—</span>,
    },
    {
      key: "role",
      title: "Role",
    ...
    },
    {
      key: "createdAt",
      title: "Joined",
      render: (u: User) => dayjs(u.createdAt).format("MMM D, YYYY"),
    },
    {
      key: "actions",
      title: "",
